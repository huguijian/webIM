        ...
        <section id="content">
            <div class="admin-form theme-info" id="login1">
                ...
                <div class="panel panel-info mt10 br-n">
                    ...
                    <form method="post" id="login_form" method="post" action="<?php echo \common\Utils::makeUrl('login', 'register');?>" onsubmit="return login();">
                        <div class="panel-body bg-light p30">
                            <div class="row">
                                <div class="col-sm-7 pr30">
                                    <div class="section">
                                        <label for="remark_name" class="field-label text-muted fs18 mb10">昵称</label>
                                        <label for="remark_name" class="field prepend-icon">
                                            <input type="text" name="remark_name" id="remark_name" class="gui-input" placeholder="请输入昵称" tabindex="1">
                                    ...
                                    <div class="section">
                                        <label for="user_pic" class="field-label text-muted fs18 mb10">头像地址</label>
                                        <label for="user_pic" class="field prepend-icon">
                                            <input type="text" name="avatar" id="avatar" value="" class="gui-input" placeholder="请输入头像URL" tabindex="1">
                                            <label for="username" class="field-icon">
                                                <i class="fa fa-user"></i>
                                            </label>
                                        </label>
                                ...
                                <div class="col-sm-5 br-l br-grey pl30">
                                    ...
                                    <p class="mb15 xx_color_info">
                                        你可以注册<span class="xx_font_big2">IM</span>
                                    </p>
                                    <p class="mb15 xx_color_info">
                        ...
                        <div class="panel-footer p10 ph15 text-center">
                            <button type="submit" id="btn_submit" class="btn xx_btn-lg btn-primary xx_font_big6" tabindex="3">注 册</button>
                        </div>
                    </form>
