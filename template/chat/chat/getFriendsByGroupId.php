...
<li>
    ...
    <h6>
        ...
        <?php endif; ?>
        <button type="button" class="btn btn-primary  btn-xs" onclick="delFriend(this,<?php echo $vo['to_user_id']; ?>);">删除</button>
    </h6>
</li>
<?php endforeach; ?>
<script>
    function delFriend(obj,user_id) {
        var delFriendUrl = '{"a":"main/chat","m":"delFriend","user_id":"'+user_id+'","my_id":"<?php echo $user_id; ?>"}';
